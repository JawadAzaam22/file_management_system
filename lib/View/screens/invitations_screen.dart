                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                            ...
                                            child:   CustomText(
                                              text: "${controller.invites[index].groupInfoDTO?.name}",
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ElevatedButton(
                                              onPressed: () => controller.accept(index,controller.invites[index].id),
                                            ...
                                            ElevatedButton(
                                              onPressed: () => controller.reject(index,controller.invites[index].id),
                                              style: ElevatedButton.styleFrom(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      SizedBox(width: 5,),
                                      CustomText(
                                        text: "${controller.invites[index].groupInfoDTO?.owner?.username}",
